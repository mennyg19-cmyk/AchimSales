...
**Status:** DECIDED (owner pre-authorized the migration: "back up the current database first, then do the cutover and verify the worker drains the queue"; running autonomously)
