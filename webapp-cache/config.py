...
# SharePoint pickup folder for report files from Azure Automation
WEBAPP_PICKUP_FOLDER = os.environ.get(
    "WEBAPP_PICKUP_FOLDER", "D365 F&O/webapp_reports"
)

# Background refresh interval (seconds). Default: 1 hour.
