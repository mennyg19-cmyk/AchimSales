...
REGISTRY: tuple[ReportSpec, ...] = (
    ...
    # Cached v3 payloads displayed the SP rate instead of the saved master percent.
    ReportSpec("invoiced", "Invoiced", ReportStatus.BUILT, builder_version=4, salesman_default=True),
