...
from report_engine.lib import eastern_datetime, first_of, num, text
...
def clean_rows(rows: Iterable[dict]) -> list[dict]:
    ...
    for row in rows:
        out.append({
            ...
            "CreatedDateTime": eastern_datetime(_cell(row, "CreatedDateTime")),
            ...
            "OffsetCreatedDateTime": eastern_datetime(_cell(row, "OffsetCreatedDateTime")),
