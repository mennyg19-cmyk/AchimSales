...
def _rows():
    ...
    return [
        ...
        {"SalesOrderNumber": "SO3", "CustomerAccount": "100", "customername": "Acme",
         ...
         "QuantityOrdered": "10", "ShippedQuantity": "10", "ReleasedQuantity": "10",
        ...
        {"SalesOrderNumber": "SO2", "CustomerAccount": "100", "customername": "Acme",
         ...
         "ItemDescription": "Widget", "SalesPrice": "2.00", "SalesStatus": "Delivered",
         "QuantityOrdered": "5", "ShippedQuantity": "5", "ReleasedQuantity": "5",
         "DeliveryRemainder": "0", "QuantityLefttoLoad": "0",
        ...
        {"SalesOrderNumber": "SO2", "CustomerAccount": "100", "customername": "Acme",
         ...
         "QuantityOrdered": "3", "ShippedQuantity": "3", "ReleasedQuantity": "3",
         "DeliveryRemainder": "0", "QuantityLefttoLoad": "0",
        ...
        {"SalesOrderNumber": "SO9", "CustomerAccount": "100", "customername": "Acme",
         ...
         "ReleasedQuantity": "0", "DeliveryRemainder": "9", "QuantityLefttoLoad": "0",
...
def _real_dump_rows():
    ...
    return [
        {"SalesOrderNumber": "ORD795", "CustomerAccount": 11528,
         ...
         "QuantityOrdered": 30, "ShippedQuantity": 30, "ReleasedQuantity": 30,
         "DeliveryRemainder": 0, "QuantityLefttoLoad": 0,
        ...
        {"SalesOrderNumber": "ORD795", "CustomerAccount": 11528,
         ...
         "QuantityOrdered": 9, "ShippedQuantity": 9, "ReleasedQuantity": 9,
         "DeliveryRemainder": 0, "QuantityLefttoLoad": 0,
