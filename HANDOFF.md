...
**Status:** Phase 9 implementation done; **review gate waits on CI** (hashed lock + whole-tree `git diff --check`). Draft PR #1. Keep draft. Do not merge or deploy Production.
