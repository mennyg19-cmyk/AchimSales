...
Last updated: 2026-09-08 (People census confirmed; next Azure PUBLIC_BASE_URL)
...
- People: owner confirmed 2026-09-08.
- Azure `PUBLIC_BASE_URL` (this step).
...
Owner sets `PUBLIC_BASE_URL` on Azure. Keep draft. No merge.
