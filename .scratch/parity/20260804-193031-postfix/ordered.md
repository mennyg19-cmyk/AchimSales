...
- Live file: `.scratch\parity\20260804-193031-postfix\ordered__live.xlsx`
- Test file: `.scratch\parity\20260804-193031-postfix\ordered__test.xlsx`
...
- Hard differences: **161124**
- Missing sheets in /test: (none)
- Extra sheets in /test (ignored): (none)
- Per sheet: Summary=DIFF(8519), By Customer=DIFF(324), By Item=DIFF(4513), By Order=DIFF(67741), By Salesman=DIFF(60), Full Data=DIFF(79967)
- Result: **DIFFERENCES FOUND**

## Patterns + detail

```
Data comparison: .scratch\parity\20260804-193031-postfix\ordered__live.xlsx vs .scratch\parity\20260804-193031-postfix\ordered__test.xlsx
Hard differences: 161124
Result: DIFFERENCES FOUND
...
## Sheet: By Customer [DIFF]
  ...
  Patterns:
    ...
    - Value diffs by column: qty_released=118, released_dollars=115, shipped_dollars=30, ordered_dollars=17, open_dollars=12
  Missing in /test (2):
  ...
  Value diffs (312):
    ...
    customer_account=11509, salesman_code=MGrego | shipped_dollars: live=0 test=2011.0800
    customer_account=11600, salesman_code=AGrossman | shipped_dollars: live=0 test=15000
    ...
    customer_account=1412, salesman_code=JWeigand | shipped_dollars: live=19953.6800 test=19726.6300
    ...
    customer_account=1674, salesman_code=BLevin | shipped_dollars: live=410.6000 test=601.4000
    ...
    customer_account=1724, salesman_code=BLevin | shipped_dollars: live=25809.8000 test=30810.7800
    ... +262 more
...
## Sheet: By Item [DIFF]
  ...
  Patterns:
    ...
    - Value diffs by column: qty_released=1525, released_dollars=1503, ordered_dollars=417, shipped_dollars=411, qty_ordered=339
  Missing in /test (2):
  ...
  Value diffs (4486):
    ...
    item_number=163-2PL001 | shipped_dollars: live=0 test=38.8800
    item_number=200-0-PK24 | qty_released: live=24 test=248
    item_number=200-0-PK24 | released_dollars: live=25.9200 test=494.6400
    item_number=200-0-PK24 | shipped_dollars: live=468.7200 test=494.6400
    ...
    item_number=205-0-PK48 | shipped_dollars: live=1294.2700 test=1492.9900
    ...
    item_number=210-0-PK24 | shipped_dollars: live=446.0400 test=581.0900
    ... +4436 more
  Soft/cosmetic text diffs (not failing): 51
...
## Sheet: By Order [DIFF]
  ...
  Patterns:
    ...
    - Value diffs by column: po_number=21212, qty_released=20960, released_dollars=20953, order_date=4196, shipped_dollars=75
    - Top dates (value-diff rows): 2026-07-14=2895, 2026-07-13=2741, 2026-07-06=2739, 2026-07-20=2598, 2026-07-09=2375
  ...
  Extra in /test only (125):
    ...
    ... +75 more
  Value diffs (67438):
    sales_order_number=ORD00867173 | po_number: live=62953103 test=None
    ...
    sales_order_number=ORD00867174 | po_number: live=62954258 test=None
    ...
    sales_order_number=ORD00867175 | po_number: live=119118392369230 test=None
    ...
    sales_order_number=ORD00867176 | po_number: live=119118392390856 test=None
    sales_order_number=ORD00867176 | qty_released: live=0 test=2
    sales_order_number=ORD00867176 | released_dollars: live=0 test=22
    sales_order_number=ORD00867177 | po_number: live=PxxjhQKwt test=None
    ...
    sales_order_number=ORD00867178 | po_number: live=62956106 test=None
    ...
    sales_order_number=ORD00867179 | po_number: live=218088899_700 test=None
    ...
    sales_order_number=ORD00867180 | po_number: live=119118392422678 test=None
    ...
    sales_order_number=ORD00867181 | po_number: live=P40153P1G test=None
    ...
    sales_order_number=ORD00867182 | po_number: live=PBWYg7PkG test=None
    ...
    sales_order_number=ORD00867183 | po_number: live=119118392453742 test=None
    ...
    sales_order_number=ORD00867184 | po_number: live=119118392411686 test=None
    ...
    sales_order_number=ORD00867185 | po_number: live=412187329 test=None
    ...
    sales_order_number=ORD00867186 | po_number: live=412187399 test=None
    ...
    sales_order_number=ORD00867187 | po_number: live=Pt5JmvqRG test=None
    ...
    sales_order_number=ORD00867188 | po_number: live=359673967_732 test=None
    ...
    sales_order_number=ORD00867189 | po_number: live=119118392498494 test=None
...
## Sheet: By Salesman [DIFF]
  ...
  Patterns:
    ...
    - Value diffs by column: qty_released=11, released_dollars=11, shipped_dollars=8, ordered_dollars=7, qty_ordered=7
  ...
  Value diffs (55):
    ...
    salesman_code=AGrossman | qty_released: live=13885 test=37932
    salesman_code=AGrossman | released_dollars: live=86555.3400 test=297137.6800
    salesman_code=AGrossman | shipped_dollars: live=210814.2500 test=297137.6800
    ...
    salesman_code=BLevin | shipped_dollars: live=53812.5400 test=59395.5200
    ...
    salesman_code=HKaufman | shipped_dollars: live=156526.6000 test=210375.0700
    ...
    salesman_code=Integrated | shipped_dollars: live=367640.1600 test=366573.7000
    ...
    salesman_code=JWeigand | shipped_dollars: live=26288.0600 test=26479.8100
    ...
    salesman_code=MGrego | shipped_dollars: live=12283.2700 test=20770.9800
    ...
    salesman_code=MKolko | shipped_dollars: live=126374.9200 test=127488.9200
...
## Sheet: Full Data [DIFF]
  ...
  Patterns:
    ...
    - Value diffs by column: qty_released=33723, released_dollars=33652, status=5639, order_date=5416, shipped_dollars=467
    - Top dates (value-diff rows): 2026-07-13=6274, 2026-07-06=5739, 2026-07-20=4882, 2026-07-27=4506, 2026-07-14=3245
