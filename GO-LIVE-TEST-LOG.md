...
**Status:** Local inventory click-through **complete** (batches 1–6). Blocked without D365: Run report rows, CLO Excel/PDF, live schedule files. Excel rules checked in pytest.

| When (UTC) | Batch | What | Result |
|------------|-------|------|--------|
| 2026-09-03 00:38 | browser-6 | Help `?` overlay: Dashboard Overview + Ordered Report (not Recent Reports). Detail: `go-live/click-batch-6.md`. | pass |
